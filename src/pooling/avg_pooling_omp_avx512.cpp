...
// OpenMP + AVX-512 optimized AvgPooling
void avg_pooling_omp_avx512(const vector<vector<float>> &input, vector<vector<float>> &output, 
...
int main() {
    ...
    avg_pooling_omp_avx512(input, output, pool_size, stride);
